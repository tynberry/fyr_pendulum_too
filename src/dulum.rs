...
//meth part
impl Dulum {
    pub fn get_jacobi_vectors(&self, id: usize, count: usize) -> (DVector<f64>, Option<DVector<f64>>) {
        //create vectors 
        ...
        for i in id..count {
            ...
            if self.elastic {
                ...
                let len_ref = unsafe {
                    len_vector.as_mut().unwrap_unchecked()
                };
                len_ref[i * 2] = ang_sin;
    ...
    pub fn get_partial_constraint(&self, id: usize, count: usize) -> (DVector<f64>, Option<DVector<f64>>) {
        //vytvoř vektory
